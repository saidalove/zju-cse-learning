...
1. 克隆本项目 repo
    ```shell
    $ git clone https://github.com/saidalove/zju-cse-learning.git
    $ cd zju-cse-learning
    ```
...
- 对于课程请进行客观的评价，尽量不要带有主观色彩（比较主观的内容可以在页面下**评论**）
...
!!! note
    针对还完全没有内容的空页面，我们提供了一个[模板](./template.md)，可以在模板的[源码](https://github.com/saidalove/zju-cse-learning/blob/main/docs/template.md?plain=1)基础上修改使用。
